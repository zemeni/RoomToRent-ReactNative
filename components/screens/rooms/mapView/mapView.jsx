...
const MapViewTab = ({ markers, userLocation }) => {
  ...
  const handleFormSubmit = async (formData) => {
    ...
    try {
      const response = await fetch("http://192.168.1.102:4000/api/rooms", {
        method: "POST",
        headers: {
      ...
      <View style={styles.topRight}>
        ...
        >
          <FontAwesome
            name="street-view"
            size={24}
            color={mapType === "standard" ? "#b305ed" : "#0533ed"}
          />
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <MaterialIcons
            name="satellite"
            size={24}
            color={mapType === "satellite" ? "#b305ed" : "#0533ed"}
          />
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <FontAwesome5
            name="map-marked"
            size={24}
            color={mapType === "hybrid" ? "#b305ed" : "#0533ed"}
          />
        </TouchableOpacity>
      </View>
